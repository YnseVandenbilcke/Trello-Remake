...
<nav class="bg-gray-800">
    ...
    <div class="hidden sm:block" aria-hidden="true">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <form action="create-task-process.php" method="POST">
               ...
               <div class="p-2">
                ...
                <div class="p-2">
                  ...
                  <select id="progress" name="progress" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    <option data-progress="0">Not started</option>
                    <option data-progress="1">In progress</option>
                    <option data-progress="2">Finished</option>
                    <option data-progress="3">Cancelled</option>
                  </select>
                </div>
