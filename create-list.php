...
<nav class="bg-gray-800">
    ...
    <div class="hidden sm:block" aria-hidden="true">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <form action="create-list-process.php" method="POST">
          <div class="shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 bg-white sm:p-6">
                ...
                <div class="p-2">
                  ...
                  <input type="text" name="listName" id="first-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
